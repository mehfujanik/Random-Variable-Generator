...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Random Variable Generator ");

        jLabel6.setFont(new java.awt.Font("Segoe Script", 0, 11)); // NOI18N
        jLabel6.setText("Designed By : Mehfuj Anik");
       ...
       // jTextArea1.append("X=" + '\t' + "U=" + '\n' + '\n');
        for (int i = 1; i < 5000; i++) {
            ...
            if (i == 1) {
                ...
                x = x1;
                if (Objects.equals(x1, q)) {
                    break;
                }
            }

            int A = (int) Math.round(x);
            String mm1 = Integer.toString(A);
            
            int C = (int) Math.round(m);
            
            
            Double V = x/m;
            //int B = (int) Math.round(V);
            //String mm2 = Integer.toString(V);
            String mm2 = Double.toString(V);

            jTextArea1.append("x"+i+" = "+ mm1 + '\t' +"u"+i+" = "+ mm2 + '\n');
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
                jTextArea1.setText("Result Will be Shown here");
